/* eslint-disable import/no-named-as-default -- this is tiptap, i have no choice */
"use client";
  ...
  return (
    ...
    >
      <EditorProvider
        ...
        {...props}
      >
        {/* eslint-disable-next-line react/jsx-no-useless-fragment -- These are just here to fix an error */}
        <></>
